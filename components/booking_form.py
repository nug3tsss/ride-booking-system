...
class BookingForm(CTkScrollableFrame):
    ...
    def __create_form_entries(self):
        ...
        self.__select_pickup_entry = CTkEntry(self.__select_pickup_frame, placeholder_text="Enter a pickup destination")
        self.__select_pickup_entry.pack(fill="x", pady=15, padx=15)

        self.__select_dropoff_entry = CTkEntry(self.__select_dropoff_frame, placeholder_text="Enter a dropoff destination")
