...
class HamburgerButton(CTkButton):
    ...
    def __init__(self, master, app,**kwargs):
        ...
        self.app = app
        self.image = CTkImage(light_image=Image.open("assets/hamburger_icon-light.png"), dark_image=Image.open("assets/hamburger_icon-dark.png"), size=(30, 30))
    ...
    def toggle_sidebar(self):
        if self.app.sidebar.winfo_ismapped():
            ...
            self.image = CTkImage(light_image=Image.open("assets/close_icon-light.png"), dark_image=Image.open("assets/close_icon-dark.png"), size=(30, 30))
            self.configure(image=self.image)